...
#ifndef __M_MATRIX3D_H__
#define __M_MATRIX3D_H__
...
public:
			       ...
			       Type  _m30,  Type _m31,  Type _m32,  Type _m33)
  {
	...
	void Identity()
	{
		...
		memcpy( (Type *)_items, ( const Type *)g_Identity.GetItems(), sizeof( _items ) );
		//memcpy( _items, v, sizeof( _items ) );
	}
